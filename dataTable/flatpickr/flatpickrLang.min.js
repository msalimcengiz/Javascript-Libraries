!(function (e, t) {
    ...
    var f = function () {},
        m = function (e, t, n) {
            return n.months[t ? "shorthand" : "longhand"][lang][e];
        },
        g = {
            D: f,
            F: function (e, t, n) {
                e.setMonth(n.months.longhand[lang].indexOf(t));
            },
            G: function (e, t) {
            ...
            M: function (e, t, n) {
                e.setMonth(n.months.shorthand[lang].indexOf(t));
            },
            S: function (e, t) {
        ...
        h = {
            ...
            D: function (e, t, n) {
                return t.weekdays.shorthand[lang][h.w(e, t, n)];
            },
            F: function (e, t, n) {
            ...
            l: function (e, t) {
                return t.weekdays.longhand[lang][e.getDay()];
            },
            m: function (e) {
    ...
    function y(f, g) {
        lang=(
            g.lang!=undefined
            &&
            a.months.longhand[g.lang]!=undefined
            &&
            a.months.shorthand[g.lang]!=undefined
            &&
            a.weekdays.shorthand[g.lang]!=undefined
            &&
            a.weekdays.shorthand[g.lang]!=undefined
                ?g.lang:'en');
            ...
            (function (e) {
                ...
                if (void 0 !== n.value && 2 === n.value.length) {
                    var s = n === h.hourElement,
                        u = n === h.minuteElement;
                    d < a ? ((d = r + d + o(!s) + (o(s) && o(!h.amPM))), u && j(void 0, -1, h.hourElement)) : d > r && ((d = n === h.hourElement ? d - r - o(!h.amPM) : a), u && j(void 0, 1, h.hourElement)),
                    h.amPM && s && (1 === l ? d + c === 23 : Math.abs(d - c) > l) && (h.amPM.textContent = h.l10n.amPM[o(h.amPM.textContent === h.l10n.amPM[0])]),
                        (n.value = i(d));
                }
            })(e);
        ...
        function z() {
            if (h.weekdayContainer) {
                var e = h.l10n.firstDayOfWeek,
                    t = h.l10n.weekdays.shorthand[lang].slice();
